CREATE TABLESPACE DOCKER
  DATAFILE '/opt/oracle/oradata/docker01.dbf' SIZE 100M
  AUTOEXTEND ON NEXT 10M MAXSIZE UNLIMITED;


-- Sequence for BOARD_TABLE
...
-- Drop the board_table if it exists and recreate it
BEGIN
...
TABLESPACE DOCKER  -- Changed to DOCKER tablespace
PCTFREE 10
INITRANS 1
MAXTRANS 255
STORAGE
...
-- Drop the board_file_table if it exists and recreate it
BEGIN
